# -*- coding: utf-8 -*-
"""10_ANN_Joint.py  –  ANN-Joint / ANN-Direct (single network -> 6 quantiles)  ±flow × PUB/PUR × 3-seed"""
import sys, logging
...
from src.models import ANNDirect
...
if __name__ == "__main__":
    ...
    cfg = RunConfig(
        model_name  = "ANN-Direct",
        model_class = ANNDirect,
        is_rf       = False,
        loss_fn     = None,
        data        = data,
        seeds       = SEEDS,
